        ...
        Expanded(
          ...
          Container(
              ...
              child: Center(
                child: Stack(
                  children: [
                    Positioned(child: Text("Image loading...",style: TextStyle(fontSize: 20, color: Colors.black),), top: 0,right: 0,left: 0, bottom: 0,),
                    Image.file(File(
                        Provider.of<TransactionsData>(context).getfrontImagelink))
                  ],
                ),
              )),
          SizedBox(height: 20),
          ...
          Container(
              ...
              child: Center(
                child: Stack(
                  children: [
                     const Positioned(child: Text("Image loading...",style: TextStyle(fontSize: 20, color: Colors.black)), top: 0,right: 0,left: 0, bottom: 0,),
                    Image.file(File(
                        Provider.of<TransactionsData>(context).getbackImagelink))
                  ],
                ),
              )),
          GestureDetector(
